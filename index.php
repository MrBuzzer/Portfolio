...
<html lang="fr">
    <head>
        <meta charset="utf-8">
        <meta keyword="Portfolio ADALLE Killyan">
        <title>Adalle Killyan - Website</title>
        <meta title="ADALLE Killyan Website">
    ...
    <body>
        <header>
            ...
            <h1 id="page_title" class="page_title">Index</h1>
        </header>
        <main>
            ...
            <section id="block1">
                <div class="bigtitle">
                    ...
                    <!--La video est provisoire car je n'ai pas eu le temps de faire un video de moi-->
                    </div>
            </section>
        </main>
